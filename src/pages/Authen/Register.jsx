  ...
  return (
    <div className={cx("wrapper")}>
      <div className={cx("container", "position-center")}>
        ...
        <form
          className={cx("flex-center", "login-form")}
          method="post"
        ...
        >
          <span className={cx("username", "package")}>
            ...
            <input
              ...
              className={cx(
                "input",
                errors.username !== "" && isValidated.email
                  ? "error-border"
                  : ""
              )}
              name="username"
            ...
            <span
              className={cx(
                isValidated.username ? "" : "display-none",
                "error",
                "p8"
              )}
            >
          ...
          <span className={cx("email", "package")}>
            ...
            <input
              ...
              className={cx(
                "input",
                errors.email !== "" && isValidated.email ? "error-border" : ""
              )}
              name="email"
              id="email"
              autoComplete="off"
            ...
            <span
              className={cx(
                isValidated.email ? "" : "display-none",
                "error",
                "p8"
              )}
            >
          ...
          <span className={cx("password", "package")}>
            ...
            <input
              ...
              className={cx(
                "input",
                errors.password !== "" && isValidated.password
                  ? "error-border"
                  : ""
              )}
              name="password"
            ...
            <span
              className={cx(
                isValidated.password ? "" : "display-none",
                "error",
                "p8"
              )}
            >
          ...
          <span className={cx("confirm-password", "package")}>
            ...
            <input
              ...
              className={cx(
                "input",
                errors.confirmPassword !== "" && isValidated.confirmPassword
                  ? "error-border"
                  : ""
              )}
            ...
            <span
              className={cx(
                isValidated.confirmPassword ? "" : "display-none",
                "error",
                "p8"
              )}
            >
